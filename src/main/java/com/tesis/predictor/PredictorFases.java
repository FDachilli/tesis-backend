...
public class PredictorFases {
    ...
    public String predecirFases (String file, String modelFase1, String modelFase2, String modelFase3, boolean total) throws Exception {
    	String folderName = predecirFase1(file, modelFase1, total);
    ...
    public String predecirFasesCompuesto (String file, String modelFase1, String modelFase2, String modelFase3, boolean total) throws Exception {
    	String folderName = predecirFase1(file, modelFase1, total);
    	Instances fase2Results = predecirFase2(folderName, modelFase2);
        PredictorFase3Compuesto predictorFase3 = new PredictorFase3Compuesto();
        Instances fase3Results = predictorFase3.predecirFase3Compuesto(fase2Results, modelFase3, folderName);
        System.out.println (fase3Results.toString());
        Util.deleteFolder(folderName);
        return fase3Results.toString();
    }
    
    public String predecirFase1(String file, String modelFase1, boolean total) throws ParseException, IOException {
