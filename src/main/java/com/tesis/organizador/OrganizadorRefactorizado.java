 ...
 */
public class OrganizadorRefactorizado {
   ...
   // public int CANT_ROL_COMP = 9;
    ...
    public int POS_CRUDO_FECHA = 5;
    public int POS_INF_CRUDO_CONDUCTA_IPA = 6;
    public int POS_SUP_CRUDO_CONDUCTA_IPA = 17;
    public int POS_INF_CRUDO_REACCION_IPA = 18;
    public int POS_SUP_CRUDO_REACCION_IPA = 21;
    public int POS_INF_CRUDO_AREA_IPA = 22;
    public int POS_SUP_CRUDO_AREA_IPA = 23;
    public int POS_INF_CRUDO_HORARIO = 24;
    public int POS_SUP_CRUDO_HORARIO = 26;
    public int POS_MAPEO_SYMLOG_DOMINANTE = 27;
    public int POS_MAPEO_SYMLOG_SUMISO = 28;
    public int POS_MAPEO_SYMLOG_AMISTOSO = 29;
    public int POS_MAPEO_SYMLOG_NO_AMISTOSO = 30;
    public int POS_MAPEO_SYMLOG_TAREA = 31;
    public int POS_MAPEO_SYMLOG_SOCIO_EMOCIONAL = 32;


    //Dado un arff, obtengo el promedio de cada uno de los integrantes
    //Y se lo guarda en un nuevo arff.
    public OrganizadorRefactorizado(){};
